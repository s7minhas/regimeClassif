...
\begin{figure}[ht]
    ...
    \subfloat[][Polity (7--10)]{
	    \includegraphics[width=.4\textwidth]{polGe7_All_sep}
        \label{fig:sepp4}} &
    \subfloat[][Military]{
    	\includegraphics[width=.4\textwidth]{military_All_sep}
        \label{fig:sepmil}} \\
    \hspace{-7mm}
    \subfloat[][Monarchy]{
    	\includegraphics[width=.4\textwidth]{monarchy_All_sep}		
        \label{fig:sepmon}} &
    \subfloat[][Party]{
    	\includegraphics[width=.4\textwidth]{party_All_sep}		
        \label{fig:sepparty}}
    \end{tabular}
    \caption{Separation Plots of Out-of-Sample Predictions from Support Vector Machines (SVM)}
    \label{fig:polBinSep}
\end{figure}
\FloatBarrier
...
% \begin{figure}[ht]
% 	\centering
% 	\resizebox{0.7\textwidth}{!}{\input{graphics/pol_bin_probDist.tex}}	
% 	\caption{Histograms of Out-of-Sample Estimated Probabilities of Four Regime Types from Support Vector Machines (SVM)}
% \end{figure}
...
\begin{figure}[!t]
	\begin{tabular}{ll}
	    \hspace{-7mm}
		\subfloat[][Polity (7--10)]{
			\includegraphics[width=.5\textwidth]{polCat_cat4_2010_map}
			\label{fig:mapp4}} &
		\subfloat[][Military]{

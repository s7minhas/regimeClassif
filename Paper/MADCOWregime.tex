...
Footnote about trying a variety of other approaches...
...
\begin{figure}
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{sepdem}
                \caption{Democracy}
                \label{fig:sepdem}
        \end{subfigure}%
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{sepmonarchy}
                \caption{Monarchy}
                \label{fig:sepmon}
        \end{subfigure}%
        \\
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{sepmilrule}
                \caption{Military Rule}
                \label{fig:sepmilrule}
        \end{subfigure}%
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{seponeparty}
                \caption{One Party Rule}
...
\begin{figure}[!t]
        ...
        \end{subfigure}%
        \begin{subfigure}[b]{0.5\textwidth}
                \includegraphics[width=\textwidth]{map4}
                \caption{One Party Rule}

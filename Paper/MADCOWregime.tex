...
\begin{figure}
    ...
    \hspace{-7mm}	
    \subfloat[][Polity$=$7]{
		\resizebox{0.5\textwidth}{!}{\input{graphics/polGe7_sep.tex}}	
        \label{fig:sep7}} &
    \subfloat[][Polity$=$8]{
		\resizebox{0.5\textwidth}{!}{\input{graphics/polGe8_sep.tex}}	
        \label{fig:sep8}} \\
	\hspace{-7mm}	
    \subfloat[][Polity$=$9]{
		\resizebox{0.5\textwidth}{!}{\input{graphics/polGe9_sep.tex}}	
        \label{fig:sep9}} &
    \subfloat[][Polity$=$10]{
		\resizebox{0.5\textwidth}{!}{\input{graphics/polGe10_sep.tex}}	
        \label{fig:sep10}}
    \end{tabular}
